...
const Card = ({ title, content, location, numberOfPeople }) => {
  ...
  return (
    <View className="w-full bg-secondary-200 rounded-lg mt-[6px] mb-[6px] border-t-0 border-r-[0.5px] border-l-[0.5px] border-b-[0.5px] border-gray-400">
      <View className="mr-4 ml-4 mt-[16px] mb-[16px]">
        <Text className="text-[16px] text-white-100 font-pregular">{title}</Text>
        <View className="w-full h-[0.5px] bg-white-200 mt-[4px]" />
        <Text numberOfLines={1} className="text-[12px] text-white-200 mt-1 font-pextralight">
          {content}
        </Text>
        <View className="w-full h-[0.5px] bg-white-200 mt-[4px]" />
        ...
        <View className="flex-row">
          ...
          <TouchableOpacity onPress={handleView} className="absolute -right-0 w-[80px] h-[32px] bg-gray-100 items-center justify-center flex-row rounded-lg mt-[16px]">
